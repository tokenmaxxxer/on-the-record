...
# knows which two of the ~44 `roles/*.json` roles to invite when the
...
# selection here was issue #2610's separate surface (the role catalog's
# retirement) -- not absorbed into this issue.
