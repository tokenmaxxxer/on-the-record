...
2026-08-21T00:00:00Z | inline | PR #1820 orchestrator amended this issue's scope (canonical: PR #1820 orchestrator comment) to include `gates/test_closes_gate_ci.py` and `conftest.py`, bringing the gap above inside scope. Added an autouse `_isolated_gh_read_cache_approvals` fixture to `conftest.py` monkeypatching `spawn._approval_record_path` to a per-test `tmp_path`.

derived: `python3 -m pytest gates/test_closes_gate_ci.py -q` (run three times)
```
......................................................                   [100%]
54 passed in 1.29s
......................................................                   [100%]
...
See docs/issue-1818/reports/implementation.md `## Rationale for deviations` for the rejected snapshot/delete/restore alternative and its side effect.
