...
# surface for technical-writing, the same commit must also touch docs/handbooks/*.md.
# Skeleton: path heuristics for "operational surface" are a placeholder —
# harden per this role's actual write_scope (["docs/**"], 외부공개 한정) before treating as
# load-bearing.
set -uo pipefail
