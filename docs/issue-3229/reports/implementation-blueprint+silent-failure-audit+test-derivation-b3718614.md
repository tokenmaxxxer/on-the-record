...
skill-verdict: implementation-blueprint — applied: invoked; guided the episode-before-vs-after-the-ask architecture choice and the reuse-not-reimplement decision for #3061's derivation (see "Why")
