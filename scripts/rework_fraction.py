...
def analyze_session(events: list[dict]) -> dict:
    ...
    rework_episodes = []           # turn-cost per episode with re-entry
...
def _fmt_report(report: dict) -> str:
    ...
    lines = [
        ...
        f"  rework episodes (fail -> edit -> next pass/end): "
...
def _fmt_batch(summary: dict) -> str:
    ...
    lines += [
        ...
        f"total rework episodes: {summary['total_rework_episodes']}",
