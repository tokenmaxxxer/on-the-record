#!/usr/bin/env bash
# PreToolUse (Bash): issue #1130 routing-fix, cause-b role ux-engineering.
# roles/specs/ux-engineering.spec.json's use_when.trigger names
# record_absent_for: "ux-engineering" — this hook is the missing
...
# docs/issue-<n>/reports/ux-engineering.md exists for the issue resolved
...
def deny(msg):
    sys.stderr.write("ux-engineering-spawn-check: %s\n" % msg)
    sys.exit(2)
